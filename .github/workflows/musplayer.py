...
#Define all the functions to use in code
...
garmi = musfil("garmi",'3:03','C:\\users\\AMRUT\\Coding\\languages\\MyPython\\projsyntax\\MusPlayer\\mus_dir\\Neha_kakkar\\garmi.mp3')
